...
def largest_average(val1, val2, val3):
    ...
    if val1 >= val2 and val1 >= val3:
        if val2 >= val3:
            ...
            average = (val1 + val3) / 2.0
    elif val2 >= val1 and val2 >= val3:
        if val1 >= val3:
            average = (val2 + val1) / 2.0
        else:
            average = (val2 + val3) / 2.0
    else:
        if val1 >= val2:
            average = (val3 + val1) / 2.0
        else:
            average = (val3 + val2) / 2.0
...
def hoo_rah(number):
    ...
    Use word = hoo_rah(number)
    -------------------------------------------------------
    Parameters:
        number - an integer value (int)
    Returns:
        word - The resulting word (str)
    ------------------------------------------------------
    """
    if (number % 2 == 0) & (number % 7 == 0):
        word = "Hoo Rah"

    elif (number % 2 == 0) & (number % 7 != 0):
        word = "Hoo"
